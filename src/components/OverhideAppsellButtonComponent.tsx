...
const OverhideAppsellButtonComponent: React.FunctionComponent<OverhideAppsellButtonProps>  = (props) => {
  ...
  useEffect(() => {
    ...
    // See /demo-back-end
    element.addEventListener('overhide-appsell-sku-clicked', invokeOnSkuClicked);
    return () => element.removeEventListener('overhide-appsell-sku-clicked', invokeOnSkuClicked);
  }, [props.hub]);
